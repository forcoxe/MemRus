...
*/
    ...
    public RuWord seleccionar(RuEn deckWord)
    {
        ...
        Cursor consulta = db.rawQuery("SELECT * FROM ru_words WHERE id_ru_word = ?", new String[]{ String.valueOf(deckWord.getRuWord().getId())});
